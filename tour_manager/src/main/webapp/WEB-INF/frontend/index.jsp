...
<%--                </li>--%>
                ...
                <li class="nav-item ">
                        <form method="get" class="d-flex" action="/home?kw=${pageable.getKw()}#packages" >
                            <input class="form-control me-2" type="text" placeholder="Bạn muốn đi đâu?" name="kw" value="${pageable.getKw()}">
...
<div class="home">
    <div class="content">
        ...
        <a href="#packages">Đặt Tour Ngay</a>
    </div>
</div>
<!-- Home Section End -->
...
<%--                                <h6>Giá: <strong> ${String.format("%.0f", t.getPrice())} VND</strong></h6>--%>
                                ...
                                <a href="/cart?action=add&id=${t.getId()}">Đặt Ngay</a>
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p>Các địa danh đều có ẩm thực đặc sắc. Với chương trình tour du lịch, khách sẽ có cơ hội thưởng thức
                            những món ăn ngon nhất với các chương trình tuyệt vời để khách hàng trải nghiệm</p>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p>Hãng sẽ luôn đồng hành với khách hàng khám phá tất cả các địa danh nổi tiếng của các địa danh mà bạn
                            lựa chọn, thỏa sức khám phá và tìm hiểu lịch sử, văn hóa của từng địa danh.</p>
                    </div>
                </div>
        ...
        <div class="row" style="margin-top: 50px;">
            ...
            <div class="col-md-6 py-3 py-md-0">
                ...
                <p>Chào mừng bạn đến với Travel - đội ngũ chuyên viên tổ chức sự kiện đầy đam mê và tận tâm của iVIVU. Chúng
                    ...
                    xây dựng niềm tin, hoặc đơn giản chỉ là một kỳ nghỉ thuần túy.<span id="more-content"> Cam kết của chúng tôi là mang lại những kết
             ...
             trở nên mạnh mẽ và gắn kết hơn bao giờ hết! Chúng tôi cam kết mang đến cho bạn những trải nghiệm du lịch tuyệt vời nhất, bao gồm các chuyến tham quan,
                retreats công ty, và team building theo nhu cầu và mục tiêu riêng của bạn.</span></p>
