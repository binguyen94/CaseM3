  ...
  <div class="row border rounded-5 p-3 bg-white shadow box-area">
    ...
    <div class="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box"
      ...
      <div class="featured-image mb-3">
        <img src="/frontend/assets/image/ninhbinh.jpg" class="img-fluid mt-3" style="width: 450px; border-radius: 5px">
      </div>
      <p class="text-white fs-2" style="font-family: 'Courier New', Courier, monospace; font-weight: 600;">Welcome!</p>
      <small class="text-white text-wrap text-center"
             style="width: 17rem;font-family: 'Courier New', Courier, monospace;">Đăng ký ngay để khám phá rất nhiều trải nghiệm mới.</small>
