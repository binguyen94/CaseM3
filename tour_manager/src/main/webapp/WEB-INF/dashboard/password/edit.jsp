        ...
        <div class="col-6 mt-5 ">
            ...
            <form method="post">
                ...
                <div class="row mt-3 mb-3">
                    ...
                    <div class="col-9">
                        <input type="password" class="form-control mt-2" name = "newpass" value="" />
                ...
                <div class="row mb-3">
                    <div class="col-9 offset-3">
                        ...
                        <a href="/${sessionScope.user.getRole() == 'ADMIN' ? 'admin' : 'user'}"><button type="button" class="btn btn-dark">Hủy</button></a>
                    </div>
                </div>
            </form>
        </div>
