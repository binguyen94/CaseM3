...
<%--            </c:if>--%>
            ...
            <div class="row mb-3">
                <label class="col-3" >Ngày khởi hành: </label>
                <div class="col-9">
...
<%--                    <input type="text" class="form-control" name="price" value="${String.format("%.0f", tour.getPrice())}"/>--%>
            ...
            <div class="row mb-3">
                <div class="col-9 offset-3">
                    ...
                    <a href="/tours"><button type="button" class="btn btn-dark">Hủy</button></a>
                </div>
            </div>
        </form>
    </div>
